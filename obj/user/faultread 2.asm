	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001f8:	0f be 80 88 1e 80 00 	movsbl 0x801e88(%eax),%eax
  8001ff:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800309:	ff 24 85 c0 1f 80 00 	jmp    *0x801fc0(,%eax,4)
  ...
  8003d9:	8b 04 85 20 21 80 00 	mov    0x802120(,%eax,4),%eax
  8003e0:	85 c0                	test   %eax,%eax
  8003e2:	75 15                	jne    8003f9 <vprintfmt+0x179>
				printfmt(putch, putdat, "error %d", err);
  8003e4:	52                   	push   %edx
  8003e5:	68 a0 1e 80 00       	push   $0x801ea0
  8003ea:	53                   	push   %ebx
  8003eb:	57                   	push   %edi
  ...
  8003f9:	50                   	push   %eax
  8003fa:	68 3f 22 80 00       	push   $0x80223f
  8003ff:	53                   	push   %ebx
  800400:	57                   	push   %edi
  ...
  80041e:	75 07                	jne    800427 <vprintfmt+0x1a7>
				p = "(null)";
  800420:	c7 45 d4 99 1e 80 00 	movl   $0x801e99,-0x2c(%ebp)
			if (width > 0 && padc != '-')
...
sys_env_destroy(envid_t envid)
{
  ...
  800b47:	68 7f 21 80 00       	push   $0x80217f
  800b4c:	6a 23                	push   $0x23
  800b4e:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800bc8:	68 7f 21 80 00       	push   $0x80217f
  800bcd:	6a 23                	push   $0x23
  800bcf:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c0a:	68 7f 21 80 00       	push   $0x80217f
  800c0f:	6a 23                	push   $0x23
  800c11:	68 9c 21 80 00       	push   $0x80219c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800c4c:	68 7f 21 80 00       	push   $0x80217f
  800c51:	6a 23                	push   $0x23
  800c53:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800c8e:	68 7f 21 80 00       	push   $0x80217f
  800c93:	6a 23                	push   $0x23
  800c95:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800cd0:	68 7f 21 80 00       	push   $0x80217f
  800cd5:	6a 23                	push   $0x23
  800cd7:	68 9c 21 80 00       	push   $0x80219c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d12:	68 7f 21 80 00       	push   $0x80217f
  800d17:	6a 23                	push   $0x23
  800d19:	68 9c 21 80 00       	push   $0x80219c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800ed0:	50                   	push   %eax
  800ed1:	52                   	push   %edx
  800ed2:	68 ac 21 80 00       	push   $0x8021ac
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8010f7:	53                   	push   %ebx
  8010f8:	50                   	push   %eax
  8010f9:	68 ed 21 80 00       	push   $0x8021ed
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8011ce:	53                   	push   %ebx
  8011cf:	50                   	push   %eax
  8011d0:	68 09 22 80 00       	push   $0x802209
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801279:	53                   	push   %ebx
  80127a:	50                   	push   %eax
  80127b:	68 cc 21 80 00       	push   $0x8021cc
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  80145c:	68 26 22 80 00       	push   $0x802226
  801461:	68 2d 22 80 00       	push   $0x80222d
  801466:	6a 7a                	push   $0x7a
  801468:	68 42 22 80 00       	push   $0x802242
  80146d:	e8 b5 05 00 00       	call   801a27 <_panic>
	assert(r <= PGSIZE);
  801472:	3d 00 10 00 00       	cmp    $0x1000,%eax
  801477:	7e 16                	jle    80148f <devfile_read+0x65>
  801479:	68 4d 22 80 00       	push   $0x80224d
  80147e:	68 2d 22 80 00       	push   $0x80222d
  801483:	6a 7b                	push   $0x7b
  801485:	68 42 22 80 00       	push   $0x802242
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  80154b:	68 59 22 80 00       	push   $0x802259
  801550:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  8015fb:	50                   	push   %eax
  8015fc:	56                   	push   %esi
  8015fd:	68 60 22 80 00       	push   $0x802260
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  8018a9:	68 78 22 80 00       	push   $0x802278
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801a43:	56                   	push   %esi
  801a44:	50                   	push   %eax
  801a45:	68 84 22 80 00       	push   $0x802284
  ...
  801a56:	e8 9d e6 ff ff       	call   8000f8 <vcprintf>
	cprintf("\n");
  801a5b:	c7 04 24 7c 1e 80 00 	movl   $0x801e7c,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801b15:	50                   	push   %eax
  801b16:	68 a8 22 80 00       	push   $0x8022a8
  801b1b:	6a 40                	push   $0x40
  801b1d:	68 bc 22 80 00       	push   $0x8022bc
