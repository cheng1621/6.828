...
umain(int argc, char **argv)
{
  ...
  800040:	1e 80 00 
	...
	while (1) {
		sys_yield();
  800043:	e8 08 01 00 00       	call   800150 <sys_yield>
...
sys_env_destroy(envid_t envid)
{
  ...
  800118:	68 4f 1e 80 00       	push   $0x801e4f
  80011d:	6a 23                	push   $0x23
  80011f:	68 6c 1e 80 00       	push   $0x801e6c
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800199:	68 4f 1e 80 00       	push   $0x801e4f
  80019e:	6a 23                	push   $0x23
  8001a0:	68 6c 1e 80 00       	push   $0x801e6c
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001db:	68 4f 1e 80 00       	push   $0x801e4f
  8001e0:	6a 23                	push   $0x23
  8001e2:	68 6c 1e 80 00       	push   $0x801e6c
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80021d:	68 4f 1e 80 00       	push   $0x801e4f
  800222:	6a 23                	push   $0x23
  800224:	68 6c 1e 80 00       	push   $0x801e6c
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80025f:	68 4f 1e 80 00       	push   $0x801e4f
  800264:	6a 23                	push   $0x23
  800266:	68 6c 1e 80 00       	push   $0x801e6c
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8002a1:	68 4f 1e 80 00       	push   $0x801e4f
  8002a6:	6a 23                	push   $0x23
  8002a8:	68 6c 1e 80 00       	push   $0x801e6c
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002e3:	68 4f 1e 80 00       	push   $0x801e4f
  8002e8:	6a 23                	push   $0x23
  8002ea:	68 6c 1e 80 00       	push   $0x801e6c
...
sys_ipc_recv(void *dstva)
{
  ...
  800347:	68 4f 1e 80 00       	push   $0x801e4f
  80034c:	6a 23                	push   $0x23
  80034e:	68 6c 1e 80 00       	push   $0x801e6c
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  8004a1:	50                   	push   %eax
  8004a2:	52                   	push   %edx
  8004a3:	68 7c 1e 80 00       	push   $0x801e7c
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8006c8:	53                   	push   %ebx
  8006c9:	50                   	push   %eax
  8006ca:	68 bd 1e 80 00       	push   $0x801ebd
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80079f:	53                   	push   %ebx
  8007a0:	50                   	push   %eax
  8007a1:	68 d9 1e 80 00       	push   $0x801ed9
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  80084a:	53                   	push   %ebx
  80084b:	50                   	push   %eax
  80084c:	68 9c 1e 80 00       	push   $0x801e9c
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800a2d:	68 f6 1e 80 00       	push   $0x801ef6
  800a32:	68 fd 1e 80 00       	push   $0x801efd
  800a37:	6a 7a                	push   $0x7a
  800a39:	68 12 1f 80 00       	push   $0x801f12
  800a3e:	e8 b5 05 00 00       	call   800ff8 <_panic>
	assert(r <= PGSIZE);
  800a43:	3d 00 10 00 00       	cmp    $0x1000,%eax
  800a48:	7e 16                	jle    800a60 <devfile_read+0x65>
  800a4a:	68 1d 1f 80 00       	push   $0x801f1d
  800a4f:	68 fd 1e 80 00       	push   $0x801efd
  800a54:	6a 7b                	push   $0x7b
  800a56:	68 12 1f 80 00       	push   $0x801f12
...
devpipe_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800b1c:	68 29 1f 80 00       	push   $0x801f29
  800b21:	53                   	push   %ebx
...
_pipeisclosed(struct Fd *fd, struct Pipe *p)
{
  ...
  800bcc:	50                   	push   %eax
  800bcd:	56                   	push   %esi
  800bce:	68 30 1f 80 00       	push   $0x801f30
...
devcons_stat(struct Fd *fd, struct Stat *stat)
{
  ...
  800e7a:	68 48 1f 80 00       	push   $0x801f48
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  801014:	56                   	push   %esi
  801015:	50                   	push   %eax
  801016:	68 54 1f 80 00       	push   $0x801f54
  ...
  801027:	e8 53 00 00 00       	call   80107f <vcprintf>
	cprintf("\n");
  80102c:	c7 04 24 41 1f 80 00 	movl   $0x801f41,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80117f:	0f be 80 77 1f 80 00 	movsbl 0x801f77(%eax),%eax
  801186:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  80136b:	52                   	push   %edx
  80136c:	68 8f 1f 80 00       	push   $0x801f8f
  801371:	53                   	push   %ebx
  801372:	57                   	push   %edi
  ...
  801380:	50                   	push   %eax
  801381:	68 0f 1f 80 00       	push   $0x801f0f
  801386:	53                   	push   %ebx
  801387:	57                   	push   %edi
  ...
  8013a5:	75 07                	jne    8013ae <vprintfmt+0x1a7>
				p = "(null)";
  8013a7:	c7 45 d4 88 1f 80 00 	movl   $0x801f88,-0x2c(%ebp)
			if (width > 0 && padc != '-')
